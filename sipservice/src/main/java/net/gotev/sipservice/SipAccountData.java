...
public class SipAccountData implements Parcelable {
    ...
    AccountConfig getAccountConfig() {
        ...
        AccountNatConfig anc = accountConfig.getNatConfig();
        anc.setIceEnabled(true);
/*        anc.setTurnEnabled(true);
        anc.setTurnServer("turn.1.codecc.cn:3478");
        anc.setTurnUserName("codelife");
        anc.setTurnPassword("codelife@turn");
        anc.setTurnPasswordType(0);*/
    ...
    private void setVideoConfig(AccountConfig accountConfig) {
       ...
       // accountConfig.getVideoConfig().setDefaultCaptureDevice(SipServiceConstants.BACK_CAMERA_CAPTURE_DEVICE);
