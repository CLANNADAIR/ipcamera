...
public class SipCall extends Call {
    ...
    public void onCallSdpCreated(OnCallSdpCreatedParam prm) {
        ...
        Log.d(LOG_TAG,prm.getSdp().getWholeSdp());
    }
                ...
                if (connectTimestamp > 0) {
                    try {
                        sendCallStats(
                                ...
                                getStreamInfo(vidGetStreamIdx()),
                                getStreamStat(vidGetStreamIdx()));
                    } catch (Exception ex) {
    ...
    public void makeCall(String dst_uri, CallOpParam prm) throws java.lang.Exception {
        ...
        //CallSetting callSetting = prm.getOpt();
        //callSetting.setFlag(pjsua_call_flag.PJSUA_CALL_REINIT_MEDIA.swigValue());
